...
\centering
	...
	\caption{\hl{Relationship of the input and output focal ratios for the 100x{\SI{300}{\micro\meter}} rectangular fiber both with and without agitation.}}
\label{fig:frd}
\end{figure}
